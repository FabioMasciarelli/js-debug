...
function displayEvenNumbers() {
    ...
    let evenNumbers = [];
    for (let i = 0; i < numbers.length; i++) { // era presenta un punto e virgola in più (dopo l'incremento) ed era nuovamente sbagliato la condizione dato che bisogna inserire 3 uguali e non 1
        if (numbers[i] % 2 === 0); {
